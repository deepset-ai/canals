...
class TestSum(BaseTestComponent):
    ...
    def test_sum_expects_no_values_receives_no_values(self):
        ...
        assert component.init_parameters == {"inputs": []}  # pylint: disable=no-member
    ...
    def test_sum_expects_one_value_receives_one_value(self):
        ...
        assert component.init_parameters == {"inputs": ["value_1"]}  # pylint: disable=no-member
    ...
    def test_sum_expects_few_values_receives_right_values(self):
        ...
        assert component.init_parameters == {"inputs": ["value_1", "value_2", "value_3"]}  # pylint: disable=no-member
